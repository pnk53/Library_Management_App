        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link text-black" to="/AboutUs" >About Us</router-link>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item" v-if="isSigned">
                            <router-link to="/signUp" class="nav-link text-black">
                                SignUp
                            </router-link>
                    </li>
...
export default {
    ...
    computed: {
        ...
        isLogin(){
            return this.$route.path =='/signUp' || this.$route.path == '/ContactUs' || this.$route.path == '/AboutUs';
        },
        isLogged(){
